...
export const POSITIVE: Trait[] = [
  ...
  { id: "sailors-nostalgia", name: "뱃사람의 추억", points: -2, icon: "drop", effect: "통조림 생선을 먹으면 체력 재생 +2" },
  { id: "youth", name: "젊음", points: -3, icon: "bolt", effect: "에너지 소모 20% 감소 · 스태미나 최대치 +10" },
...
export const NEGATIVE: Trait[] = [
  ...
  { id: "exhaustion", name: "탈진", points: 4, icon: "bolt", effect: "스태미나 회복 15% 감소 · 최대치 −10" },
  { id: "well-that-hurt", name: "어이쿠, 아파!", points: 2, icon: "cross", effect: "의료 키트 사용 시 자원 25% 더 소모" },
  { id: "incompetent", name: "무능한", points: 4, icon: "user", effect: "스킬 숙련 25% 감소 · 레벨 30 상한" },
  ...
  { id: "broken-container", name: "고장난 보안 컨테이너", points: 4, icon: "box", effect: "현금·열쇠·인식표 등만 수납 가능" },
